...
ggsave("canada_migration_1_01.png", mp, width = 12, height = 6)
```
...
mp <- ggplot(xx, aes(x = Year, y = BirthRate * 1000)) + 
  geom_line(size = 1, alpha = 0.7, color = "darkgreen") + 
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Measurement)) + 
  ...
  labs(title = "Population Dynamics in The Maritimes", 
       y = "Thousand People", x = NULL, caption = myCaption)
ggsave("canada_migration_1_04.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, fill = Measurement)) +
  geom_bar(stat = "identity", alpha = 0.7, color = "black", lwd = 0.2) +
  facet_wrap(Area ~ ., ncol = 5, scales = "free_y") +
  ...
  labs(title = "Net Migration", x = NULL, 
       y = "Thousand People", caption = myCaption)
ggsave("canada_migration_1_05.png", mp, width = 12, height = 6)
```
...
# Plot
mp <- ggplot(xx, aes(x = Year, y = Net / 1000)) +
...
```{r}
# Prep data
myColors <- c("steelblue", "red", "darkorange", 
...
ggsave("canada_migration_1_07.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Area)) +
  ...
  labs(title = "Net Interprovincial Migration", x = NULL,
       y = "Thousand People", caption = myCaption)
ggsave("canada_migration_1_09.png", mp, width = 6, height = 4)
```
...
# Prep data
xx <- d3 %>% 
  filter(Area == "Alberta", Year != "1971/1972",
         Sex == "Both sexes", Age != "All ages",
         Measurement == "Net-migration")
# Plot
mp <- ggplot(xx, aes(x = Age, y = Value / 1000, fill = Net)) +
  geom_bar(stat = "identity", color = "black", alpha = 0.7) +
  facet_wrap(. ~ Year, ncol = 10) +
  scale_fill_manual(values = myColors[3:4]) +
  theme_agData(legend.position = "none",
               axis.text.x = element_text(angle = 45, hjust = 1, size = 5)) +
  labs(title = "Alberta - Net Interprovincial Migration", x = NULL,
       y = "Thousand People", caption = myCaption)
...
# Prep data
xx <- d3 %>% 
  filter(Area == "Saskatchewan", Year != "1971/1972",
         Sex == "Both sexes", Age != "All ages",
         Measurement == "Net-migration")
# Plot
mp <- ggplot(xx, aes(x = Age, y = Value / 1000, fill = Net)) +
  ...
  theme_agData(legend.position = "none",
               axis.text.x = element_text(angle = 45, hjust = 1, size = 5)) +
  labs(title = "Saskatchewan - Net Interprovincial Migration", x = NULL,
       y = "Thousand People", caption = myCaption)
...
# Prep data
xx <- d3 %>% 
  filter(Area == "Ontario", Year != "1971/1972",
         Sex == "Both sexes", Age != "All ages",
         Measurement == "Net-migration")
# Plot
mp <- ggplot(xx, aes(x = Age, y = Value / 1000, fill = Net)) +
  ...
  theme_agData(legend.position = "none",
               axis.text.x = element_text(angle = 45, hjust = 1, size = 5)) +
  labs(title = "Ontario - Net Interprovincial Migration", 
       y = "Thousand People", x = NULL, caption = myCaption)
...
mp <- ggplot(xx, aes(x = Age, y = Value, fill = Net)) +
  ...
  labs(title = "Alberta Net Interprovincial Migration", 
       y = "Thousand People", x = NULL, caption = myCaption)
ggsave("canada_migration_2_04.png", mp, width = 10, height = 8)
```
...
mp <- ggplot(xx, aes(x = Age, y = Value, fill = Net)) +
  ...
  labs(title = "Alberta Net Interprovincial Migration", 
       y = "Thousand People", x = NULL, caption = myCaption)
ggsave("canada_migration_2_05.png", mp, width = 8, height = 4)
```
...
# Prep data
xx <- d3 %>% 
  filter(Area == "Saskatchewan", Year %in% c("2020/2021", "2021/2022"),
         Sex == "Both sexes", Age != "All ages",
         Measurement == "Net-migration")
# Plot
mp <- ggplot(xx, aes(x = Age, y = Value, fill = Net)) +
  ...
  theme_agData(legend.position = "none",
               axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Saskatchewan Net Interprovincial Migration", 
       y = "Thousand People", x = NULL, caption = myCaption)
ggsave("canada_migration_2_06.png", mp, width = 8, height = 4)
```
...
```{r}
# Plot
mp <- ggplot(xx, aes( Year, y = BirthRate)) +
  geom_line(color = "darkgreen", alpha = 0.7, size = 1) +
  facet_wrap(Area ~ ., ncol = 5) +
  theme_agData() +
  labs(title = "Birth Rate in Canada", x = NULL,
       y = "Births Per Thousand People", caption = myCaption)
ggsave("canada_migration_3_02.png", mp, width = 12, height = 6)
```
