...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Canada - Population Dynamics", x = NULL,
       y = "Thousand People", caption = myCaption)
ggsave("canada_migration_1_02.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Population Dynamics", x = NULL,
       y = "Thousand People", caption = myCaption)
ggsave("canada_migration_1_03.png", mp, width = 14, height = 7)
```
...
mp <- ggplot(xx, aes(x = Date, y = Net / 1000, fill = Group)) +
  ...
  labs(title = "Net Migration", x = NULL, 
       y = "Thousand People", caption = myCaption)
ggsave("canada_migration_1_06.png", mp, width = 14, height = 7)
```
...
ggsave("canada_migration_1_08.png", mp, width = 6, height = 4)
```
...
ggsave("canada_migration_1_10.png", mp, width = 12, height = 6)
```
