...
ggsave("canada_migration_5_07.png", mp, width = 6, height = 4)
```
...
ggsave("canada_migration_6_02.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Temperary Residents From India", x = NULL, 
       y = "Thousand people", caption = myCaption)
ggsave("canada_migration_6_03.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Temperary Residents From China", x = NULL, 
       y = "Thousand people", caption = myCaption)
ggsave("canada_migration_6_04.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Temperary Residents From India", x = NULL, 
       y = "Thousand people", caption = myCaption)
ggsave("canada_migration_6_05.png", mp, width = 6, height = 4)
```
