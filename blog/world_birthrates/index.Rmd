...
> - `r shiny::icon("globe")` https://ourworldindata.org/grapher/crude-birth-rate?tab=chart
...
```{r}
# Prep data
myCaption <- "www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: OWID"
