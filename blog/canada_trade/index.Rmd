...
ggsave("canada_trade_us.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_uk.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_japan.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_algeria.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_norway.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_india.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_iraq.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_russia.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_saudi_arabia.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_china.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_germany.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_mexico.png", mp, width = 10, height = 8, bg = "white")
```
...
ggsave("canada_trade_all.png", mp, width = 10, height = 8, bg = "white")
```
