...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/blog/covid_origins)"
---
...
```{r}
# Prep data
myCaption1 <- "Data: Morning Consult<br>derekmichaelwright.github.io/dblogr/blog/covid_origins"
...
#
myCaption2 <- "Data: YouGov<br>derekmichaelwright.github.io/dblogr/blog/covid_origins"
...
#
myCaption3 <- "Data: GCRI<br>derekmichaelwright.github.io/dblogr/blog/covid_origins"
...
#
myCaption4 <- "Data: Deseret News/HarrisX<br>derekmichaelwright.github.io/dblogr/blog/covid_origins"
...
plotPoll_2 <- function(xx = d2, myGroups, 
                       myColors = c("darkred", "palevioletred3", "black", 
                                    "steelblue", "darkblue")) {
  # Prep data
  xx <- xx %>% filter(Group %in% myGroups) %>%
    mutate(Group = factor(Group, levels = myGroups)) 
