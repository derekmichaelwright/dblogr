...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/blog/hex_stickers)"
---
...
# Create sticker
mp <- ggplot(xx, aes(x = Pos, y = -log10(P.value), 
                     color = factor(Chr))) + 
  geom_point(size = 0.1) + 
...
mp <- ggplot() + theme_void() +
  geom_text(aes(x = 1, y = 1, label = "abc > gdg > abc"), size = 12.5)
...
image_write(im, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/favicon.ico")
#
im <- image_append(c(im1,im2))
imm <- image_append(c(im1,im2,im3))
image_write(imm, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/logo_banner.png")
image_write(imm, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/cv/images/logo_banner.png")
image_write(imm, "featured.png")
#
image_write(im2, "C:/gitfolder/agData/man/figures/logo_agData.png")
image_write(im3, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/gwaspr/man/figures/logo_gwaspr.png")
image_write(im3, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/academic/gwas_tutorial/logo_gwaspr.png")
image_write(im4, "C:/gitfolder/cypher/man/figures/logo_cypher.png")
#
image_write(im1, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/logo_dblogr.png")
image_write(im, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/logo_agData.png")
image_write(im3, "C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/dblogr/logo_gwaspr.png")
# C:/Users/wrigh/OneDrive - University of Saskatchewan/gitfolder/
# C:/gitfolder/
```
