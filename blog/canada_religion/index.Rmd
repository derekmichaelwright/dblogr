...
```{r}
# Prep data
myCaption <- "Data: STATCAN<br>derekmichaelwright.github.io/dblogr/blog/canada_religion"
myCaption2 <- "Data: STATCAN | derekmichaelwright.github.io/dblogr/blog/canada_religion"
...
mp <- ggarrange(mp1, ggarrange(mp2, mp3, nrow = 2, legend = "none"), 
  ...
  annotate_figure(bottom = text_grob(myCaption2, size = 7, hjust = -0.2))
...
mp <- ggplot(xx, aes(x = 1, y = Percent, fill = Group)) + 
  ...
  labs(title = "Religious Beleif in Canada - 15 years and over", 
       caption = myCaption,
       y = "Million People (2021)", x = NULL)
ggsave("canada_religion_2_02.png", mp, width = 6, height = 5.5)
```
