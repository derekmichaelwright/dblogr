---
title: "Global Energy Use & Poverty"
...
https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/ZTCWYQ
...
```{r}
# Prep data
myCaption <- "derekmichaelwright.github.io/dblogr/ | Data: OurWorldInData"
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Source)) +
  ...
  scale_color_manual(values = myColors[9:7]) +
  theme_agData(legend.position = "bottom") +
  labs(title = "Global Consumption of Fossil Fuels",
       y = "Thousand TWH", x = NULL, caption = myCaption)
...
mp <- ggplot(d1, aes(x = Year, y = Percent, fill = Source)) +
  ...
  theme_agData() +
  labs(title = "Global Energy Consumption",
       y = "Percent of Total", x = NULL, caption = myCaption)
...
mp <- ggplot(xx, aes(x = Year, y = Percent, fill = Source)) +
  ...
  labs(title = "Global Energy Consumption", x = NULL,
       y = "Percent of Total Energy", caption = myCaption)
ggsave("world_energy_1_08.png", mp, width = 6, height = 3)
```
...
mp <- ggplot(xx, aes(x = Year, y = Percent, fill = Source)) +
  ...
  theme_agData(legend.position = "none") +
  labs(title = "Global Consumption of Renewable Energy",
       y = "Percent of Total Energy", x = NULL, caption = myCaption)
ggsave("world_energy_1_09.png", mp, width = 6, height = 4)
```
...
ggsave("world_energy_1_10.png", mp, width = 4.5, height = 3.5)
```
...
mp <- ggplot(xx, aes(x = CO2, y = GDP / 1000)) + 
  ...
  theme_agData() +
  labs(y = "GDP per capita (int.-$ x1000)", 
...
mp <- ggplot(xx, aes(x = CO2, y = GDP / 1000)) + 
  ...
  guides(size = F) +
  theme_agData(legend.position = "bottom") +
  labs(title = "2000 - 2018", caption = myCaption,
       y = "GDP per capita (int.-$ x1000)", 
       x = "Per capita consumption-based CO2 emissions")
ggsave("world_energy_2_04.png", mp, width = 8, height = 3.5)
```
...
mp <- ggplot(xx, aes(x = `Fossil Fuels` / 1000, y = Percent)) +
  ...
  theme_agData(legend.position = "none") +
  guides(fill = guide_legend(nrow = 2, ncol = 1)) +
  labs(title = "Fossil Fuels & Global Reduction in Poverty", 
