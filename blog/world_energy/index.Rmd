...
mp <- ggplot(xx, aes(x = Year, y = Percent, fill = Source)) +
  ...
  labs(title = "Global Energy Consumption",
       y = "Percent of Total Energy Use", x = NULL, caption = myCaption_OWID)
ggsave("world_energy_1_10.png", mp, width = 8, height = 4)
```
...
ggsave("world_energy_1_11.png", mp, width = 6, height = 3)
```
...
mp <- ggplot(xx, aes(x = Year, y = Percent, fill = Source)) +
  ...
  labs(title = "Global Consumption of \"Green\" Energy",
       y = "Percent of Total Energy Use", x = NULL, caption = myCaption_OWID)
ggsave("world_energy_1_12.png", mp, width = 6, height = 4)
```
...
ggsave("world_energy_1_13.png", mp, width = 7, height = 5)
```
