...
> - `r shiny::icon("globe")` https://energyforgrowth.org/article/the-fridge-goes-viral-as-an-illustration-of-global-energy-inequality/
> - `r shiny::icon("globe")` https://data.worldbank.org/indicator/EG.USE.ELEC.KH.PC
