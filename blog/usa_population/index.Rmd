...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/blog/usa_population)"
---
...
```{r}
# Prep data
myCaption <- "Data: USCB<br>derekmichaelwright.github.io/dblogr/blog/usa_population"
...
mp <- ggplot(xx, aes(y = Value / 1000000, x = NAME)) +
  ...
  labs(title = "2023 Population", x = NULL, 
       y = "Million People", captiopn = myCaption)
...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  labs(title = "Population", captiopn = myCaption)
...
```{r}
# Prep data
xx <- d1 %>% filter(NAME != "United States", Measurement == "POPESTIMATE")
# Plot
mp <- ggplot(xx, aes(y = Value / 1000000, x = Year)) +
  geom_line(color = "darkgreen", alpha = 0.7, size = 1.5) +
  geom_point(alpha = 0.7) +
  facet_wrap(NAME ~ ., scales = "free_y") +
  theme_agData() +
  labs(title = "California Population", x = NULL,
       y = "Million People", captiopn = myCaption)
ggsave("usa_population_1_03.png", mp, width = 14, height = 10)
```
...
![](usa_population_1_04.png)

```{r}
# Prep data
xx <- d1 %>% filter(NAME %in% c("California", "New York", "Texas", "Florida"),
                    Measurement == "POPESTIMATE")
# Plot
mp <- ggplot(xx, aes(y = Value / 1000000, x = Year)) +
  geom_line(color = "darkgreen", alpha = 0.7, size = 1.5) +
  geom_point(alpha = 0.7) +
  ...
  labs(title = "California Population", x = NULL,
       y = "Million People", captiopn = myCaption)
ggsave("usa_population_1_04.png", mp, width = 6, height = 4)
```
...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Population Change 2021", captiopn = myCaption)
...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Population Change", captiopn = myCaption,
...
mp <- plot_usmap(data = xx, values = "PopChange", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Percent Change Since 2010", captiopn = myCaption)
