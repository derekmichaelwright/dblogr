...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  labs(title = "Population", caption = myCaption)
...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Population Change 2021", caption = myCaption)
...
mp <- plot_usmap(data = xx, values = "Value", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Population Change", caption = myCaption,
...
mp <- plot_usmap(data = xx, values = "PopChange", exclude = c("AK","HI")) + 
  ...
  theme(legend.position = "right",
        plot.background = ) + 
  labs(title = "Percent Change Since 2010", caption = myCaption)
