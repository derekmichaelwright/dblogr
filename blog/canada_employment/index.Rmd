...
subtitle: "Graphs of employment measures in Canada using STATCAN data"
date: "Last updated: `r Sys.Date()`"
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/blog/canada_employment)"
---
...
```{r}
# Prep data
myCaption <- "Data: STATCAN<br>derekmichaelwright.github.io/dblogr/blog/canada_employment"
...
## Unemployment Rate {.tabset .tabset-pills}

![](canada_employment_1_1_1.png)
...
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  ...
  scale_y_continuous(breaks = seq(4, 14, by = 2), minor_breaks = 4:14) +
  scale_x_date(date_minor_breaks = "year") +
  theme_agData(legend.position = "bottom") +
  labs(title = "Canadian Unemployment Rate", 
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_1_1_1.png", mp, width = 6, height = 4)
```
...
ggsave("canada_employment_1_2_1.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_2.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, fill = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_3.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_4.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_5.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_6.png", mp, width = 9, height = 4)
```
...
![](canada_employment_1_2_7.png)

```{r}
# Prep data
xx <- d1 %>% 
  filter(Area != "Canada", Sex == "Both sexes", Date == "2026-03-15",
         Age == "15 years and over", Measurement == "Employment rate") %>%
  arrange(desc(Value)) %>%
...
mp <- ggplot(xx, aes(x = Area, y = Value, fill = Area)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_2_7.png", mp, width = 9, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  ...
  scale_x_date(date_minor_breaks = "year") +
  theme_agData(legend.position = "bottom") +
  labs(title = "Canadian Participation Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_3_1.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Sex)) +
  ...
  labs(title = "Canada - Participation rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_3_2.png", mp, width = 6, height = 4)
```
...
xx <- d1 %>% 
  filter(Area == "Canada", Sex != "Both sexes", Age != "15 years and over",
         Measurement == "Participation rate")
# Plot
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Age)) +
  ...
  labs(title = "Canada - Participation rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_1_3_3.png", mp, width = 6, height = 4)
```
...
![](canada_employment_1_3_4.png)

```{r}
# Prep data
xx <- d1 %>%
  filter(Area %in% c("British Columbia", "Alberta", "Saskatchewan", "Ontario", "Manitoba"),
         Sex == "Both sexes", Age == "15 to 24 years",
         Measurement == "Participation rate")
# Plot
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  stat_smooth(geom = "line", method = "loess") +
  theme_agData() +
  labs(title = "Canadian Participation Rate - Ages 15 to 24 years",
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_1_3_4.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  ...
  labs(title = "Canadian Unemployment Rate",
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_2_1_1.png", mp, width = 10, height = 4)
```
...
![](canada_employment_2_1_2.png)

```{r}
# Prep data
xx <- d1 %>%
  filter(Area != "Canada", Sex == "Both sexes", Age == "15 to 24 years",
         Measurement == "Unemployment rate")
# Plot
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  geom_line(size = 0.75, alpha = 0.7, color = "darkgreen") +
  facet_wrap(Area ~ ., ncol = 5) +
  theme_agData() +
  labs(title = "Canadian Unemployment Rate - Ages 15 to 24 years",
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_2_1_2.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_1.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_2.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_3.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_4.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "Newfoundland & Alberta Employment Rates", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_5.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "Newfoundland & Alberta Employment Rates", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_6.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Ontario Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_2_7.png", mp, width = 10, height = 4)
```
...
# Plot
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  geom_line(size = 0.5, alpha = 0.2, color = "darkgreen") +
  stat_smooth(geom = "line", method = "loess") +
  facet_wrap(Area ~ ., ncol = 5) +
  theme_agData() +
  labs(title = "Canadian Participation Rate - Ages 15 to 24 years",
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_2_3_1.png", mp, width = 10, height = 4)
```
...
ggsave("canada_employment_2_3_2.png", mp, width = 10, height = 5)
```
...
ggsave("canada_employment_3_1_1.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Sex)) +
  ...
  theme_agData(legend.position = "bottom") +
  labs(title = "Canada", y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_1_2.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Measurement)) + 
  ...
  labs(title = "Compared to 2019 Average", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_1_3.png", mp, width = 10, height = 4)
```
...
ggsave("canada_employment_3_1_4.png", mp, width = 8, height = 4)
```
...
xx <- d1 %>% 
  filter(Area == "Canada", Sex == "Both sexes", 
         ...
         Measurement %in% c("Full-time employment", "Part-time employment")) %>%
  mutate(MonthDiff = ifelse(Measurement == "Full-time employment", 
            Value - yy$Value[yy$Measurement == "Full-time employment"],
            Value - yy$Value[yy$Measurement == "Part-time employment"]),
...
mp <- ggplot(xx, aes(x = Date, y = MonthDiff / 1000, fill = PosNeg)) + 
  ...
  labs(title = "Compared to 2019 Average", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_1_5.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = PanDiff / 1000, fill = PosNeg)) + 
  ...
  labs(title = "Change each month since the start of the pandemic", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_1_6.png", mp, width = 8, height = 4)
```
...
![](canada_employment_3_1_7.png)

```{r}
# Prep data
x1 <- d1 %>% 
  filter(Area == "Ontario", Age == "15 years and over", Sex == "Both sexes", 
         Measurement == "Full-time employment", Date > "2023-12-01") %>%
  mutate(Change = NA)
x2 <- d1 %>% 
  filter(Area == "Ontario", Age == "15 years and over", Sex == "Both sexes", 
         Measurement == "Part-time employment", Date > "2023-12-01") %>%
  mutate(Change = NA)
#i<-"2020-03-15"
i<-2
for(i in 2:nrow(x1)) {
  # Full-time
  x1$Change[i] <- x1$Value[i] - x1$Value[i-1]
  x2$Change[i] <- x2$Value[i] - x2$Value[i-1]
}
xx <- bind_rows(x1, x2)
xx <- xx %>% mutate(PosNeg = ifelse(Change > 0, "Pos", "Neg"))
# Plot
mp <- ggplot(xx, aes(x = Date, y = Change, fill = PosNeg)) + 
  geom_bar(stat = "identity", color = "black", alpha = 0.7, lwd = 0.2) +
  facet_wrap(Measurement ~ ., scales = "free_y") +
  scale_fill_manual(values = c("darkred","steelblue")) +
  theme_agData(legend.position = "none") +
  labs(title = "Change each month since the start of the pandemic", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_1_7.png", mp, width = 8, height = 4)
```
...
ggsave("canada_employment_6_01.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = FamilyType)) +
  ...
  labs(title = "Canada - Total Median Income", x = NULL,
       y = "Canadian Dollars (x1000)", caption = myCaption)
ggsave("canada_employment_6_02.png", mp, width = 8, height = 6)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = FamilyType)) +
  ...
  labs(title = "Canada - Total Median Income", x = NULL,
       y = "Canadian Dollars (x1000)", caption = myCaption)
ggsave("canada_employment_6_03.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Rate)) +
  ...
  labs(title = "Canada - Total Median Income Growth Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_6_04.png", mp, width = 8, height = 6)
```
...
ggsave("canada_employment_6_05.png", mp, width = 8, height = 6)
```
...
ggsave("canada_employment_7_01.png", mp, width = 7, height = 5)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Canada - EI", x = NULL, 
       y = "Thousand People", caption = myCaption)
ggsave("canada_employment_7_02.png", mp, width = 7, height = 5)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Canada - EI", x = NULL, 
       y = "Thousand People", caption = myCaption)
ggsave("canada_employment_7_03.png", mp, width = 7, height = 5)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000)) +
  ...
  labs(title = "Canada - EI - ages 25 to 54 years", x = NULL, 
       y = "Thousand People", caption = myCaption)
ggsave("canada_employment_7_04.png", mp, width = 12, height = 8)
```
