...
mp <- ggplot(xx, aes(x = Date, y = Value)) +
  ...
  labs(title = "Canadian Unemployment Rate",
       y = "Percent", x = NULL, caption = myCaption)
ggsave("canada_employment_1_02.png", mp, width = 10, height = 4)
```
...
ggsave("canada_employment_2_01.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, fill = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_03.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_04.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_05.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Age)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_07.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_08.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Canadian Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_09.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "Newfoundland & Alberta Employment Rates", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_10.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "Newfoundland & Alberta Employment Rates", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_11.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Sex)) +
  ...
  labs(title = "Ontario Employment Rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_2_12.png", mp, width = 10, height = 4)
```
...
ggsave("canada_employment_3_01.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Sex)) +
  ...
  theme_agData(legend.position = "bottom") +
  labs(title = "Canada", y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_02.png", mp, width = 6, height = 4)
```
...
ggsave("canada_employment_3_03.png", mp, width = 8, height = 4)
```
...
ggsave("canada_employment_3_04.png", mp, width = 10, height = 4)
```
...
xx <- d1 %>% 
  ...
  mutate(MonthDiff = ifelse(Measurement == myMeasures[1], 
            ...
            Value - yy$Value[yy$Measurement != myMeasures[2]]),
...
mp <- ggplot(xx, aes(x = Date, y = MonthDiff / 1000, fill = PosNeg)) + 
  ...
  labs(title = "Compared to 2019 Average", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_05.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = PanDiff / 1000, fill = PosNeg)) + 
  ...
  labs(title = "Change each month since the start of the pandemic", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_06.png", mp, width = 8, height = 4)
```
...
![](canada_employment_3_07.png)

```{r}
# Prep data
x1 <- d1 %>% 
  filter(Area == "Ontario", Age == "15 years and over", Sex == "Both sexes", 
         Measurement %in% myMeasures[1], Date > "2023-12-01") %>%
  mutate(Change = NA)
x2 <- d1 %>% 
  filter(Area == "Ontario", Age == "15 years and over", Sex == "Both sexes", 
         Measurement %in% myMeasures[2], Date > "2023-12-01") %>%
  mutate(Change = NA)
#i<-"2020-03-15"
i<-2
for(i in 2:nrow(x1)) {
...
mp <- ggplot(xx, aes(x = Date, y = Change, fill = PosNeg)) + 
  ...
  labs(title = "Change each month since the start of the pandemic", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_3_07.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Sex)) +
  ...
  labs(title = "Canada - Participation rate", x = NULL,
       y = "Percent", caption = myCaption)
ggsave("canada_employment_4_01.png", mp, width = 8, height = 4)
```

## Provinces

![](canada_employment_4_02.png)
```{r}
# Prep data
xx <- d1 %>% 
...
mp <- ggplot(xx, aes(x = Date, y = Value / 1000, color = Sex)) +
  ...
  labs(title = "Canada - Participation rate - 25 to 54 years", 
       y = "Million", x = NULL, caption = myCaption)
ggsave("canada_employment_4_02.png", mp, width = 10, height = 5)
```
