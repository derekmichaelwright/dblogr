...
`r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=2510006301

`r shiny::icon("save")` [2510006301_databaseLoadingData.csv](2510006301_databaseLoadingData.csv)

`r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=2510005501

`r shiny::icon("save")` [2510005501_databaseLoadingData.csv](2510005501_databaseLoadingData.csv)

`r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=2510004601
