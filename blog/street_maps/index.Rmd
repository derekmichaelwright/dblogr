...
```{r}
# remotes::install_github("koenderks/rcityviews")
library(rcityviews)
```

## Saskatoon

![](cityview_Saskatoon.png)
...
#
mp <- cityview(name = "Saskatoon", zoom = 0.75)
#
ggsave("cityview_Saskatoon.png", mp, height = 5, width = 5, dpi = 100)
```
...
mp <- cityview(name = "Saskatoon", zoom = 0.75)
#
ggsave("cityview_Regina.png", mp, height = 5, width = 5, dpi = 100)
```
