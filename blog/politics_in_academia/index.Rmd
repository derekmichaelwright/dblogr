...
> - `r shiny::icon("globe")` [https://osf.io/preprints/psyarxiv/dnxqh_v1](https://osf.io/preprints/psyarxiv/dnxqh_v1)
...
```{r}
# Prep data
myCaption1 <- "Data: MLI<br>derekmichaelwright.github.io/dblogr/blog/politics_in_academia"
myCaption2 <- "Data: Nakhaie & Adam (2008)<br>derekmichaelwright.github.io/dblogr/blog/politics_in_academia"
d1 <- read_xlsx("data_politics_in_academia.xlsx", "Macdonald Laurier") %>%
  mutate(Party = factor(Party, levels = unique(.$Party)),
         Measurement = factor(Measurement, unique(.$Measurement)))
#
myCaption3 <- "Data: Pew Research<br>derekmichaelwright.github.io/dblogr/blog/politics_in_academia"
myRespones <- c("Mostly positive", "Equal positive and negative", "Mostly negative")
d2 <- read_xlsx("data_politics_in_academia.xlsx", "Pew - Effect") %>%
  mutate(Date = paste(Month, Year),
         Response = factor(Response, levels = myRespones))
d3 <- read_xlsx("data_politics_in_academia.xlsx", "Pew - Trust") %>%
  mutate(Date = paste(Month, Year),
         Label_Pos = ifelse(Response != "A fair amount", Percent / 2, NA))
#
myCaption4 <- "Data: Lab Langbert (2018)<br>derekmichaelwright.github.io/dblogr/blog/politics_in_academia"
d4 <- read_xlsx("data_politics_in_academia.xlsx", "Pew - Fields") %>%
...
#
myCaption5 <- "Data: Honeycutt (2025)<br>derekmichaelwright.github.io/dblogr/blog/politics_in_academia"
d5 <- read_xlsx("data_politics_in_academia.xlsx", "UofA - Ideology")
```
