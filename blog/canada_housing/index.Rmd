...
> - `r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=3410016201
...
ggsave("canada_housing_1_02.png", mp, width = 5, height = 4)
```
...
mp <- ggplot(xx) +
  ...
  labs(title = "House prices in Canada", x = NULL,
       y = "Index (2016-12 = 100)", caption = myCaption)
ggsave("canada_housing_1_03.png", mp, width = 16, height = 16)
```
...
mp <- ggplot(xx) +
  ...
  labs(title = "House prices in Saskatchewan", x = NULL,
       y = "Index (2016-12 = 100)", caption = myCaption)
ggsave("canada_housing_1_04.png", mp, width = 8, height = 4)
```
...
ggsave("canada_housing_1_05.png", mp, width = 5, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "House prices in Canada", x = NULL, 
       y = "Index (2016-12 = 100)", caption = myCaption)
ggsave("canada_housing_1_06.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Area)) +
  ...
  labs(title = "House prices in Canada", x = NULL, 
       y = "Index (2016-12 = 100)", caption = myCaption)
ggsave("canada_housing_1_07.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, color = Measurement)) +
  ...
  labs(title = "Housing Units Built in Canada", subtitle = myAreas[1], 
       y = "Units Built", x = NULL, caption = myCaption)
ggsave("canada_housing_2_02.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, fill = Measurement)) +
  ...
  labs(title = "Housing Units Built in Canada", subtitle = myAreas[1], 
       y = "Units Built", x = NULL, caption = myCaption)
ggsave("canada_housing_2_04.png", mp, width = 6, height = 5)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, fill = Measurement)) +
  ...
  labs(title = "Housing Units Built in Canada", 
       y = "Units Built", x = NULL, caption = myCaption)
ggsave("canada_housing_2_05.png", mp, width = 20, height = 15)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, fill = Measurement)) +
  ...
  labs(subtitle = "Housing Units Built in Canada", 
       y = "Units Built", x = NULL, caption = myCaption)
ggsave("canada_housing_2_07.png", mp, width = 8, height = 6)
```
