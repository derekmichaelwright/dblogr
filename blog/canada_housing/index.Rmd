...
> - `r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=3410013301
> - `r shiny::icon("save")` [3410013301_databaseLoadingData.csv](3410013301_databaseLoadingData.csv)

Bank of Canada: Interest Rates

> - `r shiny::icon("globe")` https://www.bankofcanada.ca/rates/interest-rates/canadian-interest-rates/
...
mp <- ggplot(xx, aes(x = Area, y = Value)) +
  ...
  labs(title = "Rent Prices in", y = "Dollars",
       x = NULL, caption = myCaption)
ggsave("canada_housing_5_02.png", mp, width = 8, height = 4)
```
