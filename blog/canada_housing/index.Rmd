...
#
d6 <- left_join(x2, x1, by = c("Year", "Area")) %>% 
...
# Housing vs Income {.tabset .tabset-pills}
...
mp <- ggplot(xx, aes(x = Date, y = Value, color = Measurement)) +
  ...
  labs(title = "Canada", subtitle = "Housing Price vs. Income",
       y = "Percent Change", x = NULL, caption = myCaption)
ggsave("canada_housing_6_01.png", mp, width = 6, height = 4)
```
...
anim_save("canada_housing_6_01.gif", mp, 
...
ggsave("canada_housing_7_01.png", mp, width = 40, height = 25)
```
...
mp <- ggplot(xx, aes(x = Area, y = Value)) +
  ...
  labs(title = "Rent Prices", y = "Dollars",
       x = NULL, caption = myCaption)
ggsave("canada_housing_7_02.png", mp, width = 8, height = 6)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value, color = Area)) +
  ...
  labs(title = "Rent Prices", y = "Dollars",
       x = NULL, caption = myCaption)
ggsave("canada_housing_7_04.png", mp, width = 8, height = 4)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Measurement)) +
  ...
  labs(title = "Household Spending - Canada",
       y = "Thousand Dollars", x = NULL, caption = myCaption)
ggsave("canada_housing_8_02.png", mp, width = 10, height = 6)
```

---

## Percent or Total expenditures {.tabset .tabset-pills}

## Canada

![](canada_housing_8_03.png)
...
ggsave("canada_housing_9_01.png", mp, width = 8, height = 4)
```
