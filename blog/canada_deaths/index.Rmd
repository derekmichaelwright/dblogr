...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/blog/canada_deaths)"
---
...
```{r}
# Prep data
myCaption <- "Data: STATCAN (Note: most recent years data may be incomplete)<br>derekmichaelwright.github.io/dblogr/blog/canada_deaths"
...
mp <- ggplot(xx, aes(x = Year, y = Value, alpha = Group)) +
  geom_col(color = "black", fill = "darkred", lwd = 0.2) +
  ...
  labs(title = "Death Rate in Canada", y = "Deaths per 1000 people", x = NULL,
       caption = "Data: Wikipedia<br>derekmichaelwright.github.io/dblogr/blog/canada_deaths")
...
xx <- read.csv("data_covid_releif.csv") %>%
  ...
  mutate(Quantile = factor(Quantile, levels = quantiles),
         Trait = mv(Trait, traits1, traits2),
