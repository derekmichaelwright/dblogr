...
ggWeeklyDeaths <- function(myArea = "Canada", xmin = 2010, xmax = max(d1$Year)) {
  # Prep data
...
ggsave("canada_deaths_12_02.png", mp, width = 10, height = 6)
```

---

![](canada_deaths_12_03.png)
