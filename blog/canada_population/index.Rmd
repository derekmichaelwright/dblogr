...
downloadthis::download_link(
  link = "1710000901_databaseLoadingData.csv",
  button_label = "1710000901_databaseLoadingData.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
...
downloadthis::download_link(
  link = "1710000501_databaseLoadingData.csv",
  button_label = "1710000501_databaseLoadingData.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
d2 <- read.csv("1710000501_databaseLoadingData.csv")  %>%
  ...
  mutate(Area = factor(Area, levels = myAreas),
         ...
         Year = as.numeric(Year)) %>%
  filter(!is.na(Age))
myCaption <- "\u00A9 www.dblogr.com/ | Data: STATCAN"
```
