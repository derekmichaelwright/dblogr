...
[**< Download 36-10-0400-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/canada_gdp/3610040001_databaseLoadingData.csv)

[**< Download 36-10-0402-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/canada_gdp/3610040201_databaseLoadingData.csv)
...
mp <- mp + facet_wrap(Area ~ ., scale = "free_y", ncol = 5) + 
  scale_y_continuous()
ggsave("canada_gdp_03.png", mp, width = 10, height = 4)
```
...
mp <- mp + facet_wrap(Area ~ ., ncol = 5) + 
  scale_y_continuous()
ggsave("canada_gdp_07.png", mp, width = 10, height = 4)
```
...
ggsave("canada_gdp_09.png", mp, width = 8, height = 4)
```
...
ggsave("canada_gdp_10.png", mp, width = 8, height = 4)
```
...
ggsave("canada_gdp_11.png", mp, width = 8, height = 4)
```
...
ggsave("canada_gdp_12.png", mp, width = 8, height = 4)
```
...
ggsave("canada_gdp_13.png", mp, width = 8, height = 4)
```
...
ggsave("canada_gdp_14.png", mp, width = 8, height = 4)
```
