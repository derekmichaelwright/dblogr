...
mp <- ggplot(xx, aes(x = Year, y = Value)) +
  geom_bar(stat = "identity", alpha = 0.8, fill = "darkred", color = "black") +
  scale_x_continuous(breaks = seq(1900, 2020, 20)) +
  theme_agData() +
  labs(title = "Death Rate in Canada", y = "Deaths per 1000 people", x = NULL,
         caption = "\xa9 www.dblogr.com/  |  Data: Wikipedia")
ggsave("canada_deaths_8_01.png", mp, width = 6, height = 4)
```

![](canada_deaths_8_01.png)
