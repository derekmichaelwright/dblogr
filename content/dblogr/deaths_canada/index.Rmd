...
date: "`r Sys.Date()`"
author: "Derek Michael Wright <derek.wright@usask.ca> [www.dblogr.com/](https://dblogr.com/dblogr/deaths_canada/)"
...
links:
  - icon_pack: fas
    icon: code
    name: R Script
    url: https://derekmichaelwright.github.io/htmls/dblogr/deaths_canada.html
---
...
[**< Download 13-10-0783-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/deaths_canada/1310078301_databaseLoadingData.csv)

[**< Download 13-10-0768-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/deaths_canada/1310076801_databaseLoadingData.csv)
...
ggsave("Deaths_Canada_1_01.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_01.png)
...
ggsave("Deaths_Canada_1_02.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_02.png)
...
ggsave("Deaths_Canada_1_03.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_03.png)
...
ggsave("Deaths_Canada_1_04.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_04.png)
...
ggsave("Deaths_Canada_1_05.png", mp, width = 8, height = 4)
```
...
ggsave("Deaths_Canada_1_06.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_06.png)
...
ggsave("Deaths_Canada_1_07.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_1_07.png)
...
deathPlot2 <- function(areas) {
  ...
  # Plot
  mp1 <- ggplot(xx, aes(x = JulianDate, y = Value, group = Year, color = Y2020, alpha = Y2020)) +
    geom_line() +
...
ggsave("Deaths_Canada_2_01.png", mp, width = 20, height = 8)
```

![](Deaths_Canada_2_01.png)

---

```{r}
mp <- deathPlot2(areas = "Canada")
ggsave("Deaths_Canada_2_02.png", mp, width = 8, height = 4)
```
...
ggsave("Deaths_Canada_2_03.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_2_03.png)
...
ggsave("Deaths_Canada_2_04.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_2_04.png)
...
ggsave("Deaths_Canada_2_05.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_2_05.png)
...
ggsave("Deaths_Canada_2_06.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_2_06.png)
...
ggsave("Deaths_Canada_2_07.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_2_07.png)
...
ggsave("Deaths_Canada_3_01.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_3_01.png)
...
ggsave("Deaths_Canada_3_02.png", mp, width = 8, height = 8)
```

![](Deaths_Canada_3_02.png)
...
mp <- deathPlot3(areas = areas)
ggsave("Deaths_Canada_3_03.png", mp, width = 8, height = 8)
```

![](Deaths_Canada_3_03.png)
...
mp <- deathPlot3(areas = areas)
ggsave("Deaths_Canada_3_04.png", mp, width = 8, height = 8)
```

![](Deaths_Canada_3_04.png)
...
mp <- deathPlot3(areas = areas)
ggsave("Deaths_Canada_3_05.png", mp, width = 8, height = 5)
```

![](Deaths_Canada_3_05.png)
...
mp <- deathPlot3(areas = areas)
ggsave("Deaths_Canada_3_06.png", mp, width = 8, height = 5)
```

![](Deaths_Canada_3_06.png)
...
ggsave("Deaths_Canada_3_07.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_3_07.png)
...
ggsave("Deaths_Canada_4_01.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_01.png)
...
ggsave("Deaths_Canada_4_02.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_02.png)
...
ggsave("Deaths_Canada_4_03.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_03.png)
...
ggsave("Deaths_Canada_4_04.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_04.png)
...
ggsave("Deaths_Canada_4_05.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_05.png)
...
ggsave("Deaths_Canada_4_06.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_06.png)
...
ggsave("Deaths_Canada_4_07.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_07.png)
...
ggsave("Deaths_Canada_4_08.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_4_08.png)
...
ggsave("Deaths_Canada_5_01.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_01.png)
...
ggsave("Deaths_Canada_5_02.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_02.png)
...
ggsave("Deaths_Canada_5_03.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_03.png)
...
ggsave("Deaths_Canada_5_04.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_04.png)
...
ggsave("Deaths_Canada_5_05.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_05.png)
...
ggsave("Deaths_Canada_5_06.png", mp, width = 6, height = 4)
```

![](Deaths_Canada_5_06.png)
...
mp <- ggplot(xx, aes(x = JulianDate, y = Value, group = Sex, color = Sex)) +
  ...
  labs(y = "Deaths Per Week",
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN")
ggsave("Deaths_Canada_6_01.png", mp, width = 8, height = 4)
```

![](Deaths_Canada_6_01.png)
...
```{r echo = F, eval = F}
mp <- deathPlot4(areas = "Canada")
ggsave("Deaths_Canada_5_01.png", mp, width = 8, height = 4)
```

```{r echo = F, eval = F}
mp <- deathPlot4(areas = c("Ontario", "Quebec","Saskatchewan","Alberta", "British Columbia"))
ggsave("Deaths_Canada_5_02.png", mp, width = 8, height = 8)
```

```{r echo = F, eval = F}
mp <- deathPlot4(areas = c("Canada", "Quebec","Saskatchewan"))
ggsave("Deaths_Canada_5_03.png", mp, width = 8, height = 5)
```
