...
```{r}
mp <- deathPlot3(areas = c("Ontario", "Quebec", "Nova Scotia",
...
```{r}
mp <- deathPlot3(areas = c("British Columbia","Alberta","Saskatchewan","Manitoba"))
...
```{r}
mp <- deathPlot3(areas = c("Ontario", "Quebec","Saskatchewan","Alberta", "British Columbia"))
...
```{r}
mp <- deathPlot3(areas = c("Canada","Quebec","Saskatchewan"))
...
```{r}
mp <- deathPlot3(areas = c("Canada","Ontario","Alberta"))
...
mp <- ggplot(xx, aes(x = JulianDate, y = Value, group = Sex, color = Sex)) +
  ...
  labs(y = "Deaths Per Week",
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN")
ggsave("Deaths_Canada_4_01.png", mp, width = 8, height = 4)
```
