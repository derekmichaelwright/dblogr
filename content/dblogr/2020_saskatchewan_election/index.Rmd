...
date: "`r Sys.Date()`"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.com/dblogr/2020_saskatchewan_election/)"
...
links:
  - icon_pack: fas
    icon: code
    name: R Script
    url: https://derekmichaelwright.github.io/htmls/dblogr/2020_saskatchewan_election.html
  - icon_pack: fas
    icon: file-pdf
    name: Maps PDF
    url: https://github.com/derekmichaelwright/dblogr/raw/master/content/dblogr/2020_saskatchewan_election/2020_saskatchewan_election_districts.pdf
---
...
[**< Download Data >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/2020_saskatchewan_election/2020_saskatchewan_election_data.csv)
...
dd <- read.csv("2020_saskatchewan_election_data.csv") %>% 
...
ggsave("Sask_2020_Election_01.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Party, y = Votes / 1000, fill = Party)) +
  ...
  labs(title = "2020 Saskatchewan Election", 
       y = "Thousand Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections SK")
ggsave("Sask_2020_Election_02.png", mp, width = 25, height = 12)
```

![](Sask_2020_Election_02.png)

```{r}
pdf("2020_saskatchewan_election_districts.pdf", width = 6, height = 4)
...
**PDF**: [2020_saskatchewan_election_districts.pdf](https://github.com/derekmichaelwright/dblogr/raw/master/content/dblogr/2020_saskatchewan_election/2020_saskatchewan_election_districts.pdf)
...
mp <- ggplot(xx, aes(x = Party, y = Votes / 1000, fill = Party)) +
  ...
  labs(title = "2020 Saskatchewan Election - Agricultural Ridings", 
       y = "Thousand Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections SK")
ggsave("Sask_2020_Election_03.png", mp, width = 18, height = 8)
```

![](Sask_2020_Election_03.png)
...
mp <- ggplot(xx, aes(x = Party, y = Votes / 1000, fill = Party)) +
  ...
  labs(title = "2020 Saskatchewan Election - Urban Ridings", 
       y = "Thousand Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections SK")
ggsave("Sask_2020_Election_04.png", mp, width = 18, height = 10)
```

![](Sask_2020_Election_04.png)
...
mp <- ggplot(xx, aes(x = Party, y = Votes / 10000, fill = Party)) +
  ...
  labs(title = "2020 Saskatchewan Election - Buffalo Party", 
       y = "Thousand Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections SK")
ggsave("Sask_2020_Election_05.png", mp, width = 16, height = 6)
```

![](Sask_2020_Election_05.png)
...
mp <- ggplot(xx, aes(x = Party, y = Votes / 1000, fill = Party)) +
  ...
  labs(title = "2020 Saskatchewan Election", 
       y = "Thousand Votes", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: Elections SK")
ggsave("Sask_2020_Election_06.png", mp, width = 6, height = 6)
```

![](Sask_2020_Election_06.png)
