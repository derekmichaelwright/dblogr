...
links:
  ...
  - icon_pack: fas
    icon: table
    name: Download Modeling Data
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/covid_models/models_minnesota.csv
  - icon_pack: fas
    icon: table
    name: Download Covid Data
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/covid_models/covid_usa.csv
---
...
[**< Download Modeling Data >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/covid_models/models_minnesota.csv)

Actual data

https://beta.healthdata.gov/Hospital/COVID-19-Reported-Patient-Impact-and-Hospital-Capa/g62h-syeh/data

[**< Download Covid Data >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/covid_models/covid_usa.csv)
...
xx <- left_join(x1, x2, by = c("Area","Trait"))
# Plot
mp <- ggplot(xx, aes(x = Trait, y = Value / 1000000, fill = Trait)) +
