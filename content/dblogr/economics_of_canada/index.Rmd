...
date: "`r Sys.Date()`"
author: "Derek Michael Wright <wrightmderek@gmail.com> [www.dblogr.com/](https://dblogr.com/dblogr/economics_of_canada/)"
...
[**< Download 36-10-0400-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/economics_of_canada/3610040001_databaseLoadingData.csv)

[**< Download 36-10-0402-01 >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/economics_of_canada/3610040201_databaseLoadingData.csv)
...
ggsave("economics_of_canada_09.png", mp, width = 8, height = 4)
```
...
ggsave("economics_of_canada_10.png", mp, width = 8, height = 4)
```
...
ggsave("economics_of_canada_11.png", mp, width = 8, height = 4)
```
...
ggsave("economics_of_canada_12.png", mp, width = 8, height = 4)
```
...
ggsave("economics_of_canada_13.png", mp, width = 8, height = 4)
```

![](economics_of_canada_13.png)
