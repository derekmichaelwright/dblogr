...
![Figure 3: An illustration of how a scaled secondary axis can be used to manipulate the data visualization.](misleading_graphs_03.png)

In this example, the two data sets are at least related to eachother. However, if they arent, dual y-axes can also lead to spurious correlations.

# 3. Spurious Correlations

Spurious correlation occur when two variables appear to have a cause-and-effect relationship, when in reality, there may not be. *e.g.*, between Nicloas Cage films and the number of deaths by drowning.  
...
![Figure 4: An illustration of how correlation does not nessesarily equal causation.](misleading_graphs_04.png)

---

# 4. Cherry Picking Data

The National Interagency Fire Center (NIFC) recently deleted data from their database. Let take a look at the data they deleted and speculate why they deleted it.
...
[**< Download Data >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/misleading_graphs/fires_usa.csv)
...
![Figure 5: An illustration of how one can cherry pick data to tell a desired story.](misleading_graphs_05.png)
...
![Figure 6: An illustration of how one can cherry pick data to tell a desired story.](misleading_graphs_06.png)
