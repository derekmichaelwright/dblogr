...
ggsave("canada_population_demographics_01.png", mp, width = 10, height = 6)
```

![](canada_population_demographics_01.png)
...
ggsave("canada_population_demographics_02.png", mp, width = 6, height = 4)
```
...
![](canada_population_demographics_02.png)

---

```{r}
mp <- gg_PopDem_anim("Canada")
anim_save("canada_population_demographics_gif_02.gif", mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_02.gif)
...
ggsave("canada_population_demographics_03.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_03.png)

---

```{r}
mp <- gg_PopDem_anim(areas)
anim_save(paste0("canada_population_demographics_gif_03.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_03.gif)
...
ggsave("canada_population_demographics_04.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_04.png)

---

```{r}
mp <- gg_PopDem_anim(areas)
anim_save(paste0("canada_population_demographics_gif_04.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_04.gif)
...
ggsave("canada_population_demographics_05.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_05.png)

---

```{r}
mp <- gg_PopDem_anim("British Columbia")
anim_save(paste0("canada_population_demographics_gif_05.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_05.gif)
...
ggsave("canada_population_demographics_06.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_06.png)

---

```{r}
mp <- gg_PopDem_anim("Alberta")
anim_save(paste0("canada_population_demographics_gif_06.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_06.gif)
...
ggsave("canada_population_demographics_07.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_07.png)

---

```{r}
mp <- gg_PopDem_anim("Saskatchewan")
anim_save(paste0("canada_population_demographics_gif_07.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_07.gif)
...
ggsave("canada_population_demographics_08.png", mp, width = 6, height = 4)
```

![](canada_population_demographics_08.png)

---

```{r}
mp <- gg_PopDem_anim("Saskatchewan")
anim_save(paste0("canada_population_demographics_gif_08.gif"), mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_08.gif)
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000000, color = Sex)) +
  ...
  labs(y = "Million", x = NULL,
       caption = "\xa9 www.dblogr.com/ | Data: STATCAN")
ggsave("canada_population_demographics_09.png", mp, width = 12, height = 6)
```

![](canada_population_demographics_09.png)
...
mp <- ggplot(xx, aes(x = Year, y = Value, color = Sex, group = Sex)) +
  ...
  ease_aes('linear')
anim_save("canada_population_demographics_gif_09.gif", mp, width = 600, height = 400)
```

![](canada_population_demographics_gif_09.gif)
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Measurement)) +
  ...
  labs(y = "Thousand People", x = NULL,
       caption = "\xa9 www.dblogr.com/ | Data: STATCAN")
ggsave("canada_population_demographics_10.png", mp, width = 12, height = 6)
```

![](canada_population_demographics_10.png)
...
mp <- ggplot(xx, aes(x = Year, y = Value, color = Area)) +
  ...
  labs(title = "Immigration Rates", x = NULL,
       ...
       caption = "\xa9 www.dblogr.com/ | Data: STATCAN")
ggsave("canada_population_demographics_11.png", mp, width = 8, height = 4)
```

![](canada_population_demographics_11.png)
