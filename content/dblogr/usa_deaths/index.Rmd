...
mp <- ggplot(xx, aes(x = Date, y = Death.Rate)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_01.png", mp, width = 12, height = 12)
```
...
mp <- ggplot(x1, aes(x = Date, y = Death.Rate, color = Area)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_02.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(x1, aes(x = Date, y = Death.Rate, color = Area)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_03.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(x1, aes(x = Date, y = Death.Rate, color = Area)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_04.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Death.Rate, color = Area)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_05.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Death.Rate, group = Area)) +
  ...
  labs(x = NULL, y = "Deaths per million people per week", 
       caption = "\xa9 www.dblogr.com/  |  Data: CDC")
ggsave("usa_deaths_5_06.png", mp, width = 6, height = 4)
```
