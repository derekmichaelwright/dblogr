...
ggsave("gallery/fires_amazon_01.png", mp, width = 6, height = 4)
```
...
![Figure 1: Number of detected fires per year from 1999 - 2019.](gallery/fires_amazon_01.png)
...
mp <- ggplot(xx, aes(x = Year, y = Total / 1000)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x= NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_02.png", mp, width = 6, height = 4)
```

![Figure 2: Number of detected fires per year, from 2013 - 2020.](gallery/fires_amazon_02.png)
...
mp <- ggplot(xx, aes(x = Month, y = Value / 1000, color = Year, group = Year)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_03.png", mp, width = 6, height = 4)
```

![Figure 3: Number of detected fires per month, 2013-2019.](gallery/fires_amazon_03.png)
...
mp <- ggplot(xx, aes(x = Month, y = Value / 1000, color = Year, group = Year)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE") 
ggsave("gallery/fires_amazon_04.png", mp, width = 6, height = 4)
```

![Figure 4: Number of detected fires per month, 1998-2019.](gallery/fires_amazon_04.png)
...
mp <- ggplot(x1, aes(x = Month, y = Value / 1000, color = Year, group = Year)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_05.png", mp, width = 6, height = 4)
```

![Figure 5: Number of detected fires per month, 2012, 2013 & 2019.](gallery/fires_amazon_05.png)
...
mp <- ggplot(x1, aes(x = Month, y = Value / 1000, color = Year, group = Year)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_06.png", mp, width = 6, height = 4)
```

![Figure 6: Number of detected fires per month, 2010 & 2019.](gallery/fires_amazon_06.png)
...
mp <- ggplot(x1, aes(x = Month, y = Value / 1000, color = Year, group = Year)) + 
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_07.png", mp, width = 6, height = 4)
```

![Figure 7: Number of detected fires per month for selected years.](gallery/fires_amazon_07.png)
...
mp <- ggplot(xx, aes(x = Month, y = Value / 1000, color = Year, group = Year)) +
  ...
  labs(title = "Fires detected by the INPE",
       y = "Fires (x1000)", x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: INPE")
ggsave("gallery/fires_amazon_08.png", mp, width = 6, height = 4)
```

![Figure 8: Cumulative number of detected fires by month, 1998-2019.](gallery/fires_amazon_08.png)
