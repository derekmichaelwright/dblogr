...
[**< Download Data >**](https://github.com/derekmichaelwright/dblogr/blob/master/content/dblogr/canada_businesses/3310027001_databaseLoadingData.csv)
...
mp <- ggplot(xx, aes(x = Year, y = Businesses, fill = Pos)) +
  ...
  labs(title = "Net Business Openings/Closures", y = NULL, x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN")
ggsave("canada_businesses_06.png", mp, width = 12, height = 8)
```
...
mp <- ggplot(x1, aes(x = Date, y = Value, fill = Measurement)) +
  ...
  labs(title = "Business Openings/Closures", y = NULL, x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN")
ggsave("canada_businesses_07.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = Date, y = Value, fill = Measurement)) +
  ...
  labs(title = "Business Openings/Closures", y = NULL, x = NULL,
       caption = "\xa9 www.dblogr.com/  |  Data: STATCAN")
ggsave("canada_businesses_08.png", mp, width = 12, height = 8)
```
