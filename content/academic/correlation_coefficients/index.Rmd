...
links:
  ...
  - icon_pack: fas
    icon: table
    name: Data Set #1
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/academic/correlation_coefficients/correlation_coefficients_data_1.csv
  - icon_pack: fas
    icon: table
    name: Data Set #2
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/academic/correlation_coefficients/correlation_coefficients_data_2.csv
---
...
[Download Data set 1](https://github.com/derekmichaelwright/dblogr/blob/master/content/academic/correlation_coefficients/correlation_coefficients_data_2.csv)

[Download Data set 2](https://github.com/derekmichaelwright/dblogr/blob/master/content/academic/correlation_coefficients/correlation_coefficients_data_2.csv)
