...
links:
  ...
  - icon_pack: fas
    icon: file-pdf
    name: Maps PDF
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/crops_canada_maps/crops_canada_maps_statcan.pdf
---
...
**PDF**: [crops_canada_maps_statcan.pdf](https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/crops_canada_maps/crops_canada_maps_statcan.pdf)
