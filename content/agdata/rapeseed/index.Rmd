...
links:
  ...
  - icon_pack: fas
    icon: file-pdf
    name: PDF
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/rapeseed/rapeseed_fao.pdf
---
...
**PDF**: [rapeseed_fao.pdf](https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/rapeseed/rapeseed_fao.pdf)
