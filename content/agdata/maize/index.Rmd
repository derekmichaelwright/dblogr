...
links:
  ...
  - icon_pack: fas
    icon: file-pdf
    name: PDF
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/maize/maize_fao.pdf
---
...
**PDF**: [maize_fao.pdf](https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/maize/maize_fao.pdf)
