...
links:
  ...
  - icon_pack: fas
    icon: file-pdf
    name: PDF
    url: https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/crop_treemaps/crop_treemaps_fao.pdf
---
...
**PDF**: [crop_treemaps.pdf](https://github.com/derekmichaelwright/dblogr/blob/master/content/agdata/crop_treemaps/crop_treemaps_fao.pdf)
