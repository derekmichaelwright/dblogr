...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/academic/pca_tutorial)"
---
...
# Prep data
myCaption1 <- "derekmichaelwright.github.io/dblogr/academic/pca | Data: Anderson (1935) & Fisher (1936)"
myCaption2 <- "derekmichaelwright.github.io/dblogr/academic/pca"
```
...
xx <- read.csv("data/data_pca_tutorial_results.csv") %>% 
  mutate(Cluster = factor(Cluster), PC2 = PC2*3, PC3 = PC3*3,
         myColors = mv(Cluster, 1:8, colors))
