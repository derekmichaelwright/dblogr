...
This tutorial is will introduce the reader to <i class="fab fa-r-project"></i>, a free, open-source statistical computing environment often used with `RStudio`, a integrated development environment for <i class="fab fa-r-project"></i>.   

![R Project Logo](logo_r.png){width=25%}

---

# Download <i class="fab fa-r-project"></i>

Download <i class="fab fa-r-project"></i> at https://www.r-project.org/
...
<i class="fab fa-r-project"></i> can be used as a super awesome calculator
...
<i class="fab fa-r-project"></i> has many useful built in functions
...
Users can also create their own <i class="fab fa-r-project"></i> functions
