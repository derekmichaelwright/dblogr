...
im <- magick::image_append(c(
  ...
  magick::image_read("Fig_Cotyledon_Color_01_03.png")), 
  stack = T )
...
# Save
ggsave("Fig_Cotyledon_Color_01_01.png", mp, width = 12, height = 8, bg = "white")
```
...
# Save
ggsave("Fig_Cotyledon_Color_01_02.png", mp, width = 12, height = 4, bg = "white")
```
...
ggsave("Fig_Cotyledon_Color_03_01.png", mp, width = 12, height = 12, dpi = 600)
```
...
# Save
ggsave("Fig_Cotyledon_Color_04_01.png", mp, width = 12, height = 4)
```

![](Fig_Cotyledon_Color_04_01.png)
...
# Save
ggsave("Fig_Cotyledon_Color_04_02.png", mp, width = 10, height = 4)
```

![](Fig_Cotyledon_Color_04_02.png)
