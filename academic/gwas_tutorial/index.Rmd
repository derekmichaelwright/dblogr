---
title: "GWAS Vignette with gwaspr"
...
library(gwaspr) # Loads: tidyverse, ggpubr, ggrepel, ggtext
```
...
mp <- ggplot(xx, aes(x = Value)) + 
  ...
  theme_gwaspr() +
  labs(caption = "\u00A9 www.dblogr.com/  |  Data: AGILE")
...
```{r echo = F}
downloadthis::download_link(
  link = "GWAS_Results/GAPIT.Genotype.PCA.csv",
  button_label = "GWAS_Results/GAPIT.Genotype.PCA.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
downloadthis::download_link(
  link = "GWAS_Results/GAPIT.Genotype.Kin_Zhang.csv",
  button_label = "GWAS_Results/GAPIT.Genotype.Kin_Zhang.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
mp <- ggplot(xx,  aes(x = x, y = y)) + 
  ...
  labs(x = "PC", y = "Eigen Values",
       caption = "\u00A9 www.dblogr.com/  |  Data: AGILE")
...
mp <- gg_Manhattan(folder = "GWAS_Results/", 
  ...
  annotate_figure(fig.lab.pos = "bottom.right", fig.lab.size = 6,
                  fig.lab = "\u00A9 www.dblogr.com/  |  Data: AGILE")
...
mp <- ggplot(xx, aes(x = MAF, y = -log10(P.value))) + 
  ...
  facet_grid("FarmCPU" ~ .) +
  theme_gwaspr() +
  labs(title = "Testa_Pattern", y = "-log10(p)",
       caption = "\u00A9 www.dblogr.com/  |  Data: AGILE")
...
mp <- ggplot(xx, aes(x = MAF, y = -log10(P.value))) + 
  ...
  facet_grid("MLMM" ~ .) +
  theme_gwaspr() +
  labs(title = "DTF_Sask_2017_CV_b", y = "-log10(p)",
       caption = "\u00A9 www.dblogr.com/  |  Data: AGILE")
