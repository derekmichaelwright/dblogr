...
```{r}
mp <- gg_LDheatmap(xg = myG, chr = 2, pos1 = 43000000, pos2 = 46000000,
                   myMs = "Lcu.1GRN.Chr2p44545877", 
                   #axisTextSize = 6, 
                   nameTrim = "Lcu.1GRN.Chr2",
                   myTitle = "Lentil Diversity Panel"
                   )
ggsave("Fig_DTF_Nepal_2017_03_01.png", mp, width = 8, height = 8, dpi = 600)
```
...
```{r}
mp <- gg_LDheatmap(xg = myG, chr = 5, pos1 = 0, pos2 = 3000000,
                   myMs = "Lcu.1GRN.Chr5p1658484", 
                   #axisTextSize = 6, 
                   nameTrim = "Lcu.1GRN.Chr2",
                   myTitle = "Lentil Diversity Panel"
                   )
ggsave("Fig_DTF_Nepal_2017_03_02.png", mp, width = 8, height = 8, dpi = 600)
```
...
```{r}
mp <- gg_LDheatmap(xg = myG, chr = 6, pos1 = 2000000, pos2 = 5000000,
                   myMs = "Lcu.1GRN.Chr6p3269280", 
                   #axisTextSize = 6, 
                   nameTrim = "Lcu.1GRN.Chr6",
                   myTitle = "Lentil Diversity Panel"
                   )
ggsave("Fig_DTF_Sask_2017_03_01.png", mp, width = 8, height = 8, dpi = 600)
```
...
```{r}
mp <- gg_LDheatmap(xg = myG, chr = 1, pos1 = 364000000, pos2 = 367000000,
                   myMs = "Lcu.1GRN.Chr1p365986872", 
                   #axisTextSize = 6, 
                   nameTrim = "Lcu.1GRN.Chr1",
                   myTitle = "Lentil Diversity Panel"
                   )
ggsave("Fig_Cotyledon_Color_03_01.png", mp, width = 8, height = 8, dpi = 600)
```
