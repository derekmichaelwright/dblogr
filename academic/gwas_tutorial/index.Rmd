...
<font size="5"> `r shiny::icon("save")` [myY.csv](myY.csv) </font>

<font size="5"> `r shiny::icon("save")` [myG_hmp.zip](myG_hmp.zip) </font>

<font size="5"> `r shiny::icon("save")` [myCV.csv](myCV.csv) </font>

<font size="5"> `r shiny::icon("save")` [myM.csv](myM.csv) </font>
...
<font size="5"> `r shiny::icon("save")` [GWAS_Results/GAPIT.Genotype.PCA.csv](GWAS_Results/GAPIT.Genotype.PCA.csv) </font>

<font size="5"> `r shiny::icon("save")` [GWAS_Results/GAPIT.Genotype.Kin_Zhang.csv](GWAS_Results/GAPIT.Genotype.Kin_Zhang.csv) </font>
