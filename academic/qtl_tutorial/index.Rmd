...
```{r echo = F}
downloadthis::download_link(
  link = "LR68_results.csv",
  button_label = "LR68_results.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r echo = F}
downloadthis::download_link(
  link = "https://dblogr.com/academic/qtl_tutorial/qtl_tutorial_results_LR68.pdf",
  button_label = "qtl_tutorial_results_LR68.pdf",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r echo = F}
downloadthis::download_link(
  link = "LR95_results.csv",
  button_label = "LR95_results.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r echo = F}
downloadthis::download_link(
  link = "LR89_results.csv",
  button_label = "LR89_results.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
