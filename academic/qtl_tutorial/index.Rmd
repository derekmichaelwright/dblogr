---
title: "QTL Tutorial"
subtitle: "A tutorial on how to run QTL analyses in R"
date: "`r Sys.Date()`"
...
`qtl2` Tutorial: https://kbroman.org/qtl2/assets/vignettes/user_guide.html
...
<font size="5"> `r shiny::icon("save")` [input_LR95.zip](input_LR95.zip) </font>

<font size="5"> `r shiny::icon("save")` [input_LR89.zip](input_LR89.zip) </font>

<font size="5"> `r shiny::icon("save")` [input_LR68.zip](input_LR68.zip) </font>
...
<font size="5"> `r shiny::icon("save")` [LR68_results.csv](LR68_results.csv) </font>
...
```{r results="hide"}
# Plot
png("qtl_tutorial_LR68_02.png", width = 1000, height = 1200, res = 200)
...
```{r results="hide"}
# Plot
png("qtl_tutorial_LR68_03.png", width = 1000, height = 500, res = 200)
par(mar = c(2,4,2,1))
...
# Plot
png("qtl_tutorial_LR68_04.png", width = 1000, height = 600, res = 200)
par(mar = c(2,4,2,1))
...
# Plot
png("qtl_tutorial_LR68_05.png", width = 1000, height = 600, res = 200)
par(mar = c(2,4,2,1))
...
```{r results="hide"}
# Prep plot 
png("qtl_tutorial_LR68_06.png", width = 1500, height = 600, res = 200)
...
# Plot
png("qtl_tutorial_LR68_07.png", width = 1000, height = 600, res = 200)
par(mar = c(4,4,2,2.5))
...
myColors2 <- c("slateblue", "violetred")
# Plot
png("qtl_tutorial_LR68_08.png", width = 2000, height = 600, res = 200)
...
myColors2 <- c("slateblue", "violetred")
# Plot
png("qtl_tutorial_LR68_09.png", width = 1000, height = 600, res = 200)
par(mar = c(4,4,2,2.5))
...
mp <- ggplot(xx %>% filter(!is.na(pos)), 
  ...
  scale_color_manual(values = myColors) +
  theme_gwaspr(legend.position = "none") +
  labs(title = "LR68 QTL Results", y = "LOD", x = "100 Mbp")
...
<font size="5"> `r shiny::icon("save")` [qtl_tutorial_results_LR68.pdf](qtl_tutorial_results_LR68.pdf) </font>
...
mp <- ggplot(xx, aes(x = cM, y = value, color = Model)) + 
  ...
  labs(title = "LR68 QTL Results - Model Comparisons", y = "LOD")
...
<font size="5"> `r shiny::icon("save")` [LR95_results.csv](LR95_results.csv) </font>
...
```{r results="hide"}
# Plot
png("qtl_tutorial_LR95_02.png", width = 1000, height = 800, res = 200)
...
```{r results="hide"}
# Prep plot 
png("qtl_tutorial_LR95_03.png", width = 1000, height = 600, res = 200)
par(mfrow = c(1,2), mar = c(2,4,2,1))
# Plot QTL 1
...
ggsave("qtl_tutorial_LR95_05.png", mp, width = 8, height = 6)
# Plot by physical location - pseudomarkers removed
mp <- ggplot(xx %>% filter(!is.na(pos)), 
             aes(x = pos/100000000, y = value, color = trait)) + 
  geom_line(alpha = 0.8) +
  ...
  scale_color_manual(values = myColors) +
  theme_gwaspr() +
  labs(title = "LR95 QTL Results", y = "LOD", x = "100 Mbp")
ggsave("qtl_tutorial_LR95_06.png", mp, width = 8, height = 6)
xx[1:10,]
```
...
mp2 <- ggplot(yy %>% filter(chr == "1"), aes(x = pos / 100000000, y = value)) +
  ...
  facet_grid(trait ~ paste("Chr", chr), scales = "free", space = "free_x") +
  theme_gwaspr() +
  labs(title = "LR95 Physical Location", y = "LOD", x = "100 Mbp")
...
<font size="5"> `r shiny::icon("save")` [LR89_results.csv](LR89_results.csv) </font>
...
```{r results="hide"}
# Plot
png("qtl_tutorial_LR89_02.png", width = 1000, height = 1200, res = 200)
par(mfrow = c(4,1), mar = c(2,4,2,1))
plot(out, map, lodcolumn = 1, col = myColors[1], 
...
# Plot
png("qtl_tutorial_LR89_03.png", width = 1200, height = 500, res = 200)
...
# Plot
png("qtl_tutorial_LR89_04.png", width = 1200, height = 500, res = 200)
par(mfrow = c(1,3), mar=c(2,4,2,1))
plot_pxg(xx, myQTL$pheno[,"RootRot_E1"], ylab = "RootRot_E1")
...
# Plot
png("qtl_tutorial_LR89_05.png", width = 1200, height = 500, res = 200)
par(mfrow = c(1,3), mar=c(2,4,2,1))
plot_pxg(xx, myQTL$pheno[,"RootRot_E1"], ylab = "RootRot_E1")
...
# Plot
png("qtl_tutorial_LR89_06.png", width = 1200, height = 500, res = 200)
par(mfrow = c(1,3), mar=c(2,4,2,1))
plot_pxg(xx, myQTL$pheno[,"RootRot_E1"], ylab = "RootRot_E1")
...
myLims <- c(-4.4,4.4)
# Plot
png("qtl_tutorial_LR89_07.png", width = 1000, height = 1600, res = 200)
...
myLims <- c(-4.3,4.3)
# Plot
png("qtl_tutorial_LR89_08.png", width = 1000, height = 1600, res = 200)
par(mfrow = c(3,1), mar = c(4,4,2,2.5))
...
myLims <- c(-4.2,4.2)
# Plot
png("qtl_tutorial_LR89_09.png", width = 1000, height = 1600, res = 200)
par(mfrow = c(3,1), mar = c(4,4,2,2.5))
...
mp <- ggplot(xx, aes(x = cM, y = value, color = trait)) + 
  ...
  scale_color_manual(values = myColors) +
  theme_gwaspr() + 
  labs(title = "LR89 QTL Results", y = "LOD")
