...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/academic/mendel)"
---
...
myCaption2 <- "Data: Mendel (1865)<br>derekmichaelwright.github.io/dblogr/"
#
...
ggMendel1 <- function(xx = d1 %>% filter(Expt == 1), 
  ...
  # Plot
  ggplot(xx, aes(x = 1)) +
    geom_col(aes(y = Percentage, fill = Trait), alpha = 0.7) +
