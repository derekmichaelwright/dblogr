...
downloadthis::download_link(
  link = "https://github.com/derekmichaelwright/AGILE_LDP_Phenology/blob/master/data/data_tb_pc.csv",
  button_label = "Tb and Pc (data_tb_pc.csv)",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
```{r echo = F}
downloadthis::download_link(
  link = "data_env_sutherland_2017.csv",
  button_label = "data_env_sutherland_2017.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
downloadthis::download_link(
  link = "data_env_morocco_2017.csv",
  button_label = "data_env_morocco_2017.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
