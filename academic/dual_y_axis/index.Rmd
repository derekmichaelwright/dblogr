...
<font size="5"> `r shiny::icon("save")` [data_dual_y_axis.csv](data_dual_y_axis.csv) </font>
...
mp1 <- ggplot(xx, aes(x = Date)) +
  ...
  labs(title = "Environmental Data", y = "Temperature (\u00B0C)", x = NULL,
       caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: AGILE") +
...
ggplot(xx, aes(x = x, y = y)) + 
  ...
  scale_y_continuous(limits = c(20, 40), 
                     sec.axis = sec_axis(~ (. - 20) * (10 - 5) / (20 - 0) + 5,
                        name = "y2", breaks = 5:10)) +
  labs(caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: AGILE")
```
