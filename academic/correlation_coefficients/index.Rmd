...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/academic/correlation_coefficients)"
---
...
```{r}
# Prep data
myCaption <- "derekmichaelwright.github.io/dblogr/academic/correlation_coefficients"
myColors <- c("darkgreen","darkorange","darkblue")
# Remove any rows with missing data
d1 <- read_xlsx("data_correlation_coefficients.xlsx", "data_1") %>%
  filter(!is.na(DTF), !is.na(DTS), !is.na(DTM)) %>%
...
mp <- ggarrange(mp1, mp2, mp3, nrow = 1, align = "h",
  ...
  annotate_figure(bottom = text_grob(myCaption, size = 7, hjust = -0.65))
...
```{r echo = F} 
ggsave("featured.png", mp1, width = 6, height = 3.5)
```
