...
subtitle: "An R tutorial on how to properly use correlation coefficients when evaluating predictive models"
date: "`r Sys.Date()`"
...
downloadthis::download_link(
  link = "data_correlation_coefficients.xlsx",
  button_label = "data_correlation_coefficients.xlsx",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
