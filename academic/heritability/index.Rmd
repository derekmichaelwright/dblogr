...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/academic/heritability)"
---
...
```{r}
# Prep data
myCaption1 <- "Data: Johannsen (1903)<br>derekmichaelwright.github.io/dblogr/academic/heritability"
...
```{r}
# Prep data
myCaption3 <- "Data: East (1916)<br>derekmichaelwright.github.io/dblogr/academic/heritability"
...
```{r}
myCaption4 <- "Data: Collins *et al*. (1930)<br>derekmichaelwright.github.io/dblogr/academic/heritability"
...
# Prep data
myCaption <- "Data: Johannsen (1903)<br>derekmichaelwright.github.io/dblogr/academic/heritability"
