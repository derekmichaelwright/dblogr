...
```{r}
# Prep data
myCaption1 <- "Data: Johannsen (1903)\nderekmichaelwright.github.io/dblogr/academic/heritability"
...
```{r}
# Prep data
myCaption3 <- paste("Data: East (1916)\nderekmichaelwright.github.io/dblogr/academic/heritability")
...
```{r}
myCaption4 <- expression(paste("Data: Collins ", italic("et al"), 
    ". (1930)\nderekmichaelwright.github.io/dblogr/academic/heritability"))
...
# Prep data
myCaption <- paste("Data: Johannsen (1903)\nderekmichaelwright.github.io/dblogr/academic/heritability")
