...
<font size="5"> `r shiny::icon("save")` [TBRTQuality.csv](TBRTQuality.csv) </font>
...
mp <- ggplot(xx, aes(x = Line, color = Expt)) +
  ...
  labs(y = "Brix", caption = "\u00A9 derekmichaelwright.github.io/dblogr/")
...
mp <- ggplot(yy, aes(x = Group, y = Brix, color = Group)) +
  ...
  labs(x = NULL, caption = "\u00A9 derekmichaelwright.github.io/dblogr/")
...
mp <- ggplot(xx %>% filter(Selection != ""), 
  ...
  labs(title = paste("h^2 =", round(myfit$coefficients[2], 2)),
       x = "Parental Mean", y = "Progeny Mean",
