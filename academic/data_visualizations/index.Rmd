...
downloadthis::download_link(
  link = "data_visualizations_1.csv",
  button_label = "data_visualizations_1.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
...
downloadthis::download_link(
  link = "data_visualizations_2.csv",
  button_label = "data_visualizations_2.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = FALSE
...
library(agData)
myCaption <- "\u00A9 www.dblogr.com/ | Data: AGILE"
```
