...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/academic/data_visualizations)"
---
...
xx <- read.csv("data_raw.csv") %>%
  filter(Name %in% myEntries, 
         Expt %in% expts) %>%
  mutate(Location = mv(Location, locs, labels)) %>% 
...
library(agData)
myCaption <- "derekmichaelwright.github.io/dblogr/academic/data_visualizations"
...
ggsave("data_visualizations_02.png", mp, width = 6, height = 4, bg = "white")
```
