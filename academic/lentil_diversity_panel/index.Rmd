...
mp <- ggplot(xx, aes(x = Origin, y = Count, fill = Region)) + 
  ...
  labs(title = "Lentil Diversity Panel Origins", x = NULL,
       caption = myCaption)
ggsave("lentil_diversity_panel_01.png", mp, width = 8, height = 4)
```
...
xx <- dd %>% 
  mutate(Lat = ifelse(is.na(Lat), Country_Lat, Lat),
         ...
         Size = 1)
# Plot png
png("lentil_diversity_panel_02.png", width = 3600, height = 2055, res = 600)
...
xx <- dd %>% 
  ...
  as.data.frame()
# Plot
png("lentil_diversity_panel_03.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i",yaxs = "i")
mapBubbles2(dF = xx, nameX = "Country_Lon", nameY = "Country_Lat", 
            ...
            xlim = c(-140,110), ylim = c(5,20), lwd = 1,
            oceanCol = "grey90", landCol = "white", borderCol = "black")
title(main = "Lentil Diversity Panel", line = 0, cex = 3)
dev.off()
```
...
xx <- dd %>% 
  ...
  as.data.frame()
# Plot
png("lentil_diversity_panel_04.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
...
xx <- dd %>% 
  ...
  as.data.frame()
# Plot
png("lentil_diversity_panel_05.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
mapPies(dF = xx, nameX = "Country_Lon", nameY = "Country_Lat", 
...
file.copy(from = "lentil_diversity_panel_05.png", to = "featured.png", overwrite = T)
```
...
![](lentil_diversity_panel_06.png)

https://dblogr.com/academic/lentil_diversity_panel/Lentil_diversity_panel_06.html

<iframe
  src="lentil_diversity_panel_06.html"
...
xx <- dd %>% 
  mutate(Lat = ifelse(is.na(Lat), Country_Lat, Lat),
         ...
         Size = 1)
# Plot png
png("lentil_diversity_panel_06.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
mapBubbles2(dF = xx, nameX = "Lon", nameY = "Lat", 
...
saveWidget(mp, file="lentil_diversity_panel_06.html")
```
...
![](lentil_diversity_panel_07.png)

https://dblogr.com/academic/lentil_diversity_panel/Lentil_diversity_panel_07.html

<iframe
  src="lentil_diversity_panel_07.html"
  style="width:100%; height:600px;"
></iframe>
...
xx <- dd %>% 
  mutate(Lat = ifelse(is.na(Lat), Country_Lat, Lat),
         ...
         Size = 1)
# Plot png
png("lentil_diversity_panel_07.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
mapBubbles2(dF = xx, nameX = "Lon", nameY = "Lat", 
            nameZFill = "STR_Group",
...
saveWidget(mp, file="lentil_diversity_panel_07.html")
```
...
mp <- ggplot(xx, aes(x = "", y = Percent, fill = DTF_Cluster)) + 
  ...
  labs(title = "Lentil Diversity Panel Origins", x = NULL,
       caption = myCaption)
ggsave("lentil_diversity_panel_08.png", width = 12, height = 6)
```
...
mp <- ggplot(xx, aes(x = "", y = Percent, fill = STR_Group)) + 
  ...
  labs(title = "Lentil Diversity Panel Origins", x = NULL,
       caption = myCaption)
ggsave("lentil_diversity_panel_09.png", mp, width = 12, height = 6)
```
...
https://dblogr.com/academic/lentil_diversity_panel/lentil_diversity_panel_10.html

<iframe
  src="lentil_diversity_panel_10.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- plot_ly(dd, x = ~myG_PC1, y = ~myG_PC3, z = ~myG_PC2, 
  ...
  add_markers()
saveWidget(as_widget(mp), "lentil_diversity_panel_10.html")
```
...
https://dblogr.com/academic/lentil_diversity_panel/lentil_diversity_panel_11.html

<iframe
  src="lentil_diversity_panel_11.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- plot_ly(dd, x = ~myG_PC1, y = ~myG_PC2, z = ~myG_PC3, hoverinfo = "text",
              ...
              text = ~paste(Name, 
                            ...
                            "\nDTF_Cluster:", DTF_Cluster)) %>%
  add_markers()
saveWidget(as_widget(mp), "lentil_diversity_panel_11.html")
```
...
https://dblogr.com/academic/lentil_diversity_panel/lentil_diversity_panel_12.html

<iframe
  src="lentil_diversity_panel_12.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- plot_ly(dd, x = ~myG_PC1, y = ~myG_PC2, z = ~myG_PC3, 
              ...
              text = ~paste(Name, 
                            ...
                            "\nDTF_Cluster:", DTF_Cluster)) %>%
  add_markers()
saveWidget(as_widget(mp), "lentil_diversity_panel_12.html")
```
...
https://dblogr.com/academic/lentil_diversity_panel/lentil_diversity_panel_13.html

<iframe
  src="lentil_diversity_panel_13.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- plot_ly(dd, x = ~DTF_PC1, y = ~DTF_PC2*2.5, z = ~DTF_PC3*2.5,
              ...
              text = ~paste(Name, 
                            ...
                            "\nDTF_Cluster:", DTF_Cluster)) %>%
  add_markers()
saveWidget(as_widget(mp), "lentil_diversity_panel_13.html")
```

---

https://dblogr.com/academic/lentil_diversity_panel/lentil_diversity_panel_14.html

<iframe
  src="lentil_diversity_panel_14.html"
  style="width:100%; height:600px;"
  data-external="1"
></iframe>
...
mp <- plot_ly(dd, x = ~DTF_PC1, y = ~DTF_PC2, z = ~DTF_PC3,
              ...
              text = ~paste(Name, 
                            ...
                            "\nDTF_Cluster:", DTF_Cluster)) %>%
  add_markers()
saveWidget(as_widget(mp), "lentil_diversity_panel_14.html")
```
...
mp <- ggplot(xx, aes(x = Name, y = Value, fill = Group)) +
  ...
  labs(title = "Lentil Diversity Panel", y = NULL, x = NULL,
       caption = myCaption)
ggsave("lentil_diversity_panel_15.png", mp, width = 10, height = 4)
```
...
mp <- ggplot(xx, aes(x = Name, y = Value, fill = Group)) +
  ...
  labs(title = "Lentil Diversity Panel", y = NULL, x = NULL,
       caption = myCaption)
ggsave("lentil_diversity_panel_16.png", mp, width = 10, height = 4)
```
...
xx <- dd %>% 
  ...
  mutate(Lat = ifelse(is.na(Lat), Country_Lat, Lat),
         ...
         Size = 1)
# Plot png
png("lentil_diversity_panel_17.png", width = 3600, height = 2055, res = 600)
par(mai = c(0,0,0,0), xaxs = "i", yaxs = "i")
mapBubbles2(dF = xx, nameX = "Lon", nameY = "Lat", 
...
mp <- ggplot(xx, aes(x = CotyledonColor, y = SeedMass1000, 
  ...
  labs(title = "Lentil Diversity Panel",
       ...
       x = "Cotyledon Color",
       caption = myCaption)
ggsave("lentil_diversity_panel_18.png", mp, width = 6, height = 4)
```
...
mp <- ggplot(xx, aes(x = CotyledonColor, y = SeedMass1000, 
  ...
  theme_agData() +
  labs(caption = myCaption)
ggsave("lentil_diversity_panel_20.png", mp, width = 10, height = 4)
```
