...
> - `r shiny::icon("globe")` Canada's Covid data: https://health-infobase.canada.ca/covid-19/dashboard/about.html

![](misleading_graphs_03.png)

```{r}
# Prep data
myCaption <- "www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: PHAC"
#
...
ggsave("misleading_graphs_03.png", mp, width = 6, height = 10, bg = "white")
```
...
> - `r shiny::icon("globe")` FAO data on Organic hectares: http://www.fao.org/faostat/en/#data/RL
> - `r shiny::icon("globe")` Data for Quebec autism rates can be found at https://www.canada.ca/en/public-health/services/publications/diseases-conditions/autism-spectrum-disorder-children-youth-canada-2018.html.

![](misleading_graphs_04.png)

```{r}
# Prep data
myCaption <- "www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: STATCAN & FAOSTAT"
#
...
ggsave("misleading_graphs_04.png", mp, width = 9, height = 9)
```
...
> - `r shiny::icon("globe")` USDA data https://www.nass.usda.gov/
...
> - `r shiny::icon("globe")` https://www.nifc.gov/fire-information/statistics/wildfires
> - `r shiny::icon("globe")` https://web.archive.org/web/20210129125036/https://www.nifc.gov/fireInfo/fireInfo_stats_totalFires.html

![](misleading_graphs_06.png)

```{r}
# Prep data
myCaption <- "www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: NIFC"
#
...
mp2 <- ggplot(dd, aes(x = Year, y = Acres / 1000000, fill = Group)) + 
  ...
  labs(subtitle = "B) Full data set",
       y = "Million Acres", x = NULL, caption = myCaption)
...
> - `r shiny::icon("globe")` https://www.eia.gov/dnav/pet/pet_pri_gnd_dcus_nus_w.htm

![](misleading_graphs_07.png)

```{r}
# Prep data
myCaption <- "www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: EIA"
#
...
ggsave("misleading_graphs_08.png", mp, width = 12, height = 4, bg = "white")
```

We can also illustrate this by attempting different way to present results from the 2016 US election.

> - `r shiny::icon("globe")` https://raw.githubusercontent.com/tonmcg/US_County_Level_Election_Results_08-20/
...
ggsave("misleading_graphs_09.png", mp, width = 8, height = 5, bg = "grey90")
# Plot Counties
...
mp4 <- ggplot(xx, aes(x = lon, y = lat, 
  ...
  theme(legend.position = "none")
mp <- ggarrange(mp1, mp2, mp3, mp4, nrow = 2, ncol = 2, heights = c(1,0.8))
ggsave("misleading_graphs_10.png", mp, width = 8, height = 5, bg = "grey90")
```
...
> - `r shiny::icon("globe")` https://en.wikipedia.org/wiki/Anscombe's_quartet

![](misleading_graphs_11.png)
...
ggsave("misleading_graphs_11.png", mp, width = 8, height = 5)
#
xx %>% group_by(DataSet) %>%
