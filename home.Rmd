...
author: "Derek Michael Wright [dblogr](derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> github.com/derekmichaelwright twitter.com/DerekMWright"
---
...
- &nbsp; `r shiny::icon("file-pdf")` [Curriculum Vitae (PDF)](cv/cv.wright.derek.pdf) 
- `r shiny::icon("laptop")` [Curriculum Vitae (HTML)](cv/)
- `r shiny::icon("envelope")` derek.wright@usask.ca

**Social Media**

- `r shiny::icon("github")`  github.com/derekmichaelwright
- `r shiny::icon("twitter")` twitter.com/DerekMWright
...
<br><div class = "row"><div class = "col-md-3">
...
<br><div class = "row"><div class = "col-md-3">
![](academic/gwaspr_tutorial/featured.png)
</div>

<div class = "col-md-9">

[GWAS Vignette with gwaspr](academic/gwaspr_tutorial)
...
Vignettes for the `r shiny::icon("r-project")` Package `agData` 
