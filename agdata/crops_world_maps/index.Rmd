...
ggCropMap_year <- function(myCrop = "Lentils, dry", 
  ...
  title(sub = "Data: FAOSTAT<br>derekmichaelwright.github.io/dblogr/agdata/crops_world_maps",
        line = 0, cex.sub = 0.5, adj = 1)
  legend(-185,10, title = "Yearly Statistics:",
       legend = c(paste("Max  =", round(max(xx$Value)), unique(xx$Unit)),
                  paste("Total =", round(sum(xx$Value)), unique(xx$Unit)) ),
       bty="o", box.lty=0, cex = 0.5, horiz = F, bg="white")
  dev.off()
}
```
...
![](Wheat/Wheat_Production_2024.png)
...
```{r echo = F}
ggCropMap_bind(myCrop = "Wheat", myMeasure = "Production", myYears = c(2024,1970))
```

```{r echo = F}
file.copy(from = "Wheat_Production_2024_1970.png", to = "featured.png", overwrite = T)
```
...
![](Barley/Barley_Production_2024.png)
...
![](Maize (corn)/Maize (corn)_Production_2024.png)
...
![](Rapeseed or canola oil, crude/Rapeseed or canola oil, crude_Production_2024.png)
...
![](Lentils, dry/Lentils, dry_Production_2024.png)
...
![](Chick peas, dry/Chick peas, dry_Production_2024.png)
...
![](Peas, dry/Peas, dry_Production_2024.png)
...
![](Beans, dry/Beans, dry_Production_2024.png)
...
![](Soya beans/Soya beans_Production_2024.png)
...
![](Sugar beet/Sugar beet_Production_2024.png)
...
![](Hempseed/Hempseed_Production_2024.png)
...
![](Potatoes/Potatoes_Production_2024.png)
...
![](Cotton seed/Cotton seed_Production_2024.png)
...
![](Sorghum/Sorghum_Production_2024.png)
