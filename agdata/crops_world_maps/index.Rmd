...
ggCropMap <- function(myCrop = "Lentils", 
  ...
  title(main = paste(myMeasure, "-", myCrop,"-", myYear), 
        line = 0, cex = 3) 
  title(sub = "\u00A9 www.dblogr.com/  |  Data: FAOSTAT", 
...
```{r results="hide"}
ggCropMap(myCrop = "Sugarbeet", myYear = 2019,
          myMeasure = "Production",
...
```{r results="hide"}
ggCropMap(myCrop = "Cottonseed", myYear = 2019,
          myMeasure = "Production",
          myFilename = "crops_world_maps_coton.png")
```
