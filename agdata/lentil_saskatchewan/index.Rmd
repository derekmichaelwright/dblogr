...
downloadthis::download_link(
  link = "https://github.com/derekmichaelwright/agData/raw/master/Data/agData_SKAG_Specialty_Crops.csv",
  button_label = "agData_SKAG_Specialty_Crops.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
#
downloadthis::download_link(
  link = "https://github.com/derekmichaelwright/agData/raw/master/Data/agData_Lentil_Exports.csv",
  button_label = "agData_SKAG_Lentil_Exports.csv",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
  self_contained = F
...
mp <- ggplot(d1, aes(x = Year)) +
  ...
  labs(title = "Canadian Lentil Industry",
       y = "Production (Million Tonnes)", x = NULL,
...
mp <- ggplot(xx, aes(xmin = 0, xmax = Value / 1000000, 
  ...
  labs(title = "Saskatchewan Lentil Exports - {round(frame_time)}", 
       ...
       caption = "\u00A9 www.dblogr.com/ | Data: SK AG") +
...
mp <- ggplot(xx, aes(x = Area, y = Value / 1000, group = Area, fill = Region)) +
  ...
  scale_fill_manual(name = NULL, values = myColors) +
  theme_agData(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "Saskatchewan Lentil Exports", y = "Thousand Tonnes", x = NULL,
       caption = "\u00A9 www.dblogr.com/ | Data: SK AG")
