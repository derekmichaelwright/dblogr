...
```{r}
# Prep data
myCaption <- "derekmichaelwright.github.io/dblogr/agdata/wheat | Data: FAO"
#
...
ggsave("livestock_01.png", mp, width = 14, height = 8)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000000)) + 
  ...
  labs(title = "USA Livestock Production", x = NULL,
       y = "Million Animals", caption = myCaption)
ggsave("livestock_02.png", mp, width = 14, height = 8)
```
...
ggsave("livestock_03.png", mp, width = 12, height = 6)
```
