...
```{r}
# Prep data
myCaption <- "Data: FAOSTAT<br>derekmichaelwright.github.io/dblogr/agdata/bean"
#
d1 <- agData_FAO_Crops %>% filter(Item %in% c("Beans, dry", "Other beans, green", "String beans"))
```
...
```{r results="hide"}
# Prep data
myColors <- c("darkgoldenrod2", "darkgreen", "steelblue")
myAreas <- c("World",
