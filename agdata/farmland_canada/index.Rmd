...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/agdata/farmland_canada)"
---
...
```{r}
# Prep data
myCaption <- "Data: STATCAN<br>derekmichaelwright.github.io/dblogr/agdata/farmland_canada"
#
...
d5 <- agData_STATCAN_FarmLand_Crops
```
...
xx <- xx %>% filter(Area != "Canada") %>% 
  ...
  mutate(Area = factor(Area, levels = rev(Area)),
         Area_Short = mv(Area, d0$Area, d0$Area_Short),
...
# Plot
mp <- ggplot(xx, aes(x = "")) +
  geom_col(aes(y = -Percent, fill = Area), alpha = 0.7) +
...
xx <- d2 %>% 
  ...
  mutate(Value = ifelse(Unit == "Hectares", Value / 100000, Value / 1000),
         Unit = mv(Unit, c("Hectares", "Number of farms reporting"), 
...
![](farmland_canada_5_01.png)

```{r}
# Prep data
xx <- d5 %>% filter(Area == "Canada", Measurement == "Number of farms reporting")
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value / 1000)) +
  geom_line() +
  facet_wrap(Item ~ ., scales = "free_y") +
  theme_agData() +
  labs(title = "Numnber of Farms", caption = myCaption)
ggsave("farmland_canada_5_01.png", mp, width = 6, height = 4)
```
...
![](farmland_canada_5_02.png)

```{r}
# Prep data
xx <- d5 %>% filter(Area == "Canada", Measurement == "Average area in acres")
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value)) +
  geom_line() +
  facet_wrap(Item ~ ., scales = "free_y") +
  theme_agData() +
  labs(title = "Average area in acres", caption = myCaption)
ggsave("farmland_canada_5_02.png", mp, width = 6, height = 4)
```
...
![](farmland_canada_5_03.png)

```{r}
# Prep data
xx <- d5 %>% filter(Area == "Canada", Item == "Total wheat")
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value)) +
  geom_line() +
  ...
  theme_agData() +
  labs(title = "Average area in acres", caption = myCaption)
ggsave("farmland_canada_5_03.png", mp, width = 6, height = 4)
```
