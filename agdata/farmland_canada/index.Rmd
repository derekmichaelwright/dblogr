...
`r shiny::icon("save")` [agData_STATCAN_FarmLand_Use.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_STATCAN_FarmLand_Use.csv)

`r shiny::icon("globe")` https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=3210015201

`r shiny::icon("save")` [agData_STATCAN_FarmLand_Farms.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_STATCAN_FarmLand_Farms.csv)

`r shiny::icon("globe")`https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=3210015601

`r shiny::icon("save")` [agData_STATCAN_FarmLand_Size.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_STATCAN_FarmLand_Size.csv)

`r shiny::icon("save")` [agData_STATCAN_Region_Table.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_STATCAN_Region_Table.csv)
...
```{r}
# Prep data
myCaption <- c("www.dblogr.com/ or derekmichaelwright.github.io/dblogr/ | Data: STATCAN")
#
...
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value / 1000000)) +
  geom_bar(stat = "identity", position = "dodge", alpha = 0) +
...
```{r}
# Prep data
myItems <- c("Land in crops", "Summerfallow land", "Tame or seeded pasture")
xx <- d1 %>%
...
anim_save("farmland_canada_gifs_01.gif", mp,
          ...
          end_pause = 20, width = 1200, height = 800, res = 150)
```
