...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/agdata/maize_usa)"
---
...
```{r}
# Prep data
myCaption1 = "Data: USDA<br>derekmichaelwright.github.io/dblogr/agdata/maize_usa"
myCaption2 = "Data: USDA & NCGA<br>derekmichaelwright.github.io/dblogr/agdata/maize_usa"
myCaption3 = "Data: USDA & FAOSTAT<br>derekmichaelwright.github.io/dblogr/agdata/maize_usa"
#
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Era)) +
  ...
  scale_x_continuous(breaks = seq(1865, 2025, 10), 
                     minor_breaks = NULL, expand = 0.01) +
...
mp <- ggplot(xx) +
  ...
  scale_x_continuous(breaks = seq(1865, 2025, 10), minor_breaks = NULL, expand = 0.01) +
  theme_agData(legend.position = "bottom", 
               axis.text.x = element_text(angle = 45, hjust = 1)) +
...
mp <- ggplot(xx, aes(x = Year, y = Value / 1000, color = Measurement)) + 
  ...
  labs(title = "USA - Maize Yield Contests", x = NULL,
       y = "Tonnes / Hectare", caption = myCaption2)
ggsave("maize_usa_05.png", mp, width = 7, height = 6)
```
...
mp <- ggplot(xx, aes(x = Year, y = Value)) + 
  geom_area(color = "black", fill = "darkgreen", alpha = 0.7) +
...
mp <- ggplot(xx, aes(x = Year, y = Value)) + 
  ...
  scale_x_continuous(breaks = seq(1875, 2015, 10), 
                     minor_breaks = NULL, expand = 0.01) +
  scale_y_continuous(breaks = seq(0, 1, 0.1)) +
  theme_agData(axis.text.x = element_text(angle = 45, hjust = 1)) +
  labs(title = "USA - Hectares Needed To Produce 1 Tonne of Maize", 
...
mp <- ggplot(xx, aes(x = Year, y = Difference / 1000000)) + 
  geom_area(fill = "darkgreen", alpha = 0.7, color = "black", lwd = 0.3) +
  scale_x_continuous(breaks = seq(1940, 2020, 10),
                     minor_breaks = NULL, expand = 0.01) +
  theme_agData() +
