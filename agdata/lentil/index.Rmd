...
downloadthis::download_link(
  link = "https://github.com/derekmichaelwright/agData/raw/master/Data/agData_FAO_Crops.csv.gz",
...
#
downloadthis::download_link(
  link = "https://github.com/derekmichaelwright/agData/raw/master/Data/agData_FAO_Country_Table.csv",
...
```{r echo = F}
downloadthis::download_link(
  link = "https://dblogr.com/agdata/lentil/figures_lentil_fao.pdf",
  button_label = "figures_lentil_fao.pdf",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-file-pdf",
...
for(i in myAreas) {
  print(ggplot(xx %>% filter(Area == i)) +
    ...
    labs(title = i, y = NULL, x = NULL,
         caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: FAOSTAT") )
}
dev.off()
```
...
mp <- ggplot(xx, aes(xmin = 0, xmax = Value / 1000000, 
  ...
  labs(title = "Lentil - Production - {round(frame_time)}", 
       x = "Million Tonnes (3 year moving average)", y = NULL,
...
mp <- ggplot(xx, aes(x = Area, y = Value / 1000000, fill = Region)) + 
  ...
  labs(title = "Lentil - Production - 2019", 
       y = "Million Tonnes", x = NULL,
       caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: FAOSTAT")
...
ggPie_single <- function(crop = "Lentils", measurement = "Production", 
  ...
  ggplot(xx, aes(x = 1, fill = Area)) +
    ...
    labs(title = paste(crop, measurement),
         caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: FAOSTAT")
}
#
...
mp <- ggplot(xx, aes(x = Year, y = Area, fill = Value / 1000000)) +
  ...
  scale_fill_gradientn(name = "Million Tonnes", 
                       colors = myColors, na.value = 'white') +
  theme_agData(legend.position = "bottom", 
               bgFill = "white") +
  labs(title = "Lentil Production", x = NULL, y = NULL,
       caption = "\u00A9 derekmichaelwright.github.io/dblogr/ | Data: FAOSTAT")
