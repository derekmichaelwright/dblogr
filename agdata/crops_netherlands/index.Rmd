...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/agdata/crops_netherlands)"
---
...
```{r}
myCaption <- "Data: FAOSTAT<br>derekmichaelwright.github.io/dblogr/agdata/crops_netherlands"
```
...
xx <- agData_FAO_Crops %>% 
    filter(Area == "Netherlands", Measurement == "Production",
           !Item %in% c("Watermelons", "Green tea (not fermented), black tea (fermented) and partly fermented tea, in immediate packings of a content not exceeding 3 kg")) %>% 
  group_by(Item) %>%
