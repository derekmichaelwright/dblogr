...
`r shiny::icon("save")` [agData_ISAAA_Area.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_Area.csv)

`r shiny::icon("save")` [agData_ISAAA_Country.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_Country.csv)

`r shiny::icon("save")` [agData_ISAAA_Crop.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_Crop.csv)

`r shiny::icon("save")` [agData_ISAAA_CropPercent.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_CropPercent.csv)

`r shiny::icon("save")` [agData_ISAAA_DVDDVG.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_DVDDVG.csv)

`r shiny::icon("save")` [agData_ISAAA_Value.csv](https://github.com/derekmichaelwright/agData/raw/master/Data/agData_ISAAA_Value.csv)
...
xx <- agData_ISAAA_Crop %>% 
  filter(Measurement == "Area", Crop %in% myCrops) %>%
...
# Prep Data
xx <- agData_ISAAA_Crop %>% 
  filter(Measurement == "Percent of GE Area", Crop %in% myCrops) %>%
  mutate(Crop = factor(Crop, levels = myCrops))
...
# Prep Data
xx <- agData_ISAAA_Crop %>% 
  filter(Measurement == "Area Change", Crop %in% myCrops) %>%
  mutate(Crop = factor(Crop, levels = myCrops))
# Plot
...
# Prep Data
xx <- agData_ISAAA_Crop %>% 
  filter(Measurement == "Percent Change", Year > 1997, Crop %in% myCrops) %>%
  mutate(Crop = factor(Crop, levels = myCrops))
# Plot
...
xx <- agData_ISAAA_CropPercent %>% 
  filter(Measurement == "Percent", Crop %in% myCrops) %>%
  mutate(Crop = factor(Crop, levels = myCrops))
xE <- xx %>% top_n(1, Year) %>% pull(Value)
# Plot
mp <- ggplot(xx, aes(x = Year, y = Value, color = Crop)) +
