...
author: "Derek Michael Wright [derekmichaelwright.github.io/dblogr](https://derekmichaelwright.github.io/dblogr/) <derek.wright@usask.ca> [github](https://github.com/derekmichaelwright/dblogr/tree/main/agdata/import_export_crop)"
---
...
library(gganimate)
#
myCaption <- "Data: FAOSTAT<br>derekmichaelwright.github.io/dblogr/agdata/import_export_crop"
```
...
ggIEC <- function(myItem = "Wheat", myYear = 2019) {
  ...
  xx <- bind_rows(agData_FAO_Trade_Import_Quantity, agData_FAO_Trade_Export_Quantity) %>% 
